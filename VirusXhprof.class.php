 ...
 * Virus请求
 */
class VirusXhprof extends XhprofBase implements IPerformanceAnalysis {
	...
	public function setSwitch($data) {
		...
		$actionList = \Phplib\Xhprof\Helper\XhprofConfigRedisHelper::getActionList($server[1], $this->module, Helper\XhprofConfigRedisHelper::PLATFORM_VIRUS);
	...
	public function write() {
		...
		Helper\RedisStatisticListHelper::add($server[1], Helper\RedisStatisticListHelper::XHPROF_TYPE, $response['run_id']);
		return TRUE;
	}
